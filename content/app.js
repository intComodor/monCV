        ...
        <div className="left_side">
            <div id="game_area" className="game_area">
                <div id="jeu" className="jeu" role="button" tabIndex="0" onKeyDown={e => moveSnake(e)}>
                  ...
                  {gameOver && !win && <div id="loose">Perdu!<br/>Mauvais perdant?<br/>Vous pouvez consulter mon CV<br/>sur mon profil Linkedin <a href="https://www.linkedin.com/in/karim-bouali-36b477200/">ici</a> <br/>ou retenter votre chance.</div>}
